...
public class CreateAccountSeller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_account_seller);
        //Edittext
        ...
        createaccButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sphno_owner.length() != 11) {
                    phno_owner.setError("Number must be of 11 digits");
                    return;
                }
                ...
                if (spincode.length() != 4) {
                    pincode.setError("Pincode must be of 4 digits");
                    return;
                }
                if (sgstno.length() != 15) {
                ...
                fAuth.createUserWithEmailAndPassword(semail, spassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            db.collection("Users").document(userid).set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(CreateAccountSeller.this, "Welcome to BookCave", Toast.LENGTH_LONG).show();
                                        FirebaseAuth.getInstance().signOut();
                                        Intent i = new Intent(CreateAccountSeller.this, CustomerLogin.class);
                                        startActivity(i);
                                    } else {
                                        createaccButton.setText("Create Account");
                                        String errorMessage = Objects.requireNonNull(task.getException()).getMessage();
                                        Toast.makeText(CreateAccountSeller.this, "Error: " + errorMessage, Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                            ...
                            Toast.makeText(CreateAccountSeller.this, "Error! " + Objects.requireNonNull(task.getException()).getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
