...
public class BookInfoOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bprice.setText(String.format("Selling @ %s BDT", sprice));
        rp.setText(String.format("Renting price: %s BDT per day", rprice));
        dc.setText(String.format("Delivery charges: %s BDT", dprice));
