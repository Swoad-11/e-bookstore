...
import com.example.bookstore.BookInfoOrder;
import com.example.bookstore.R;
import com.example.bookstore.extras.SellingBook;
...
public class HomecFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        sliderModels.add(new SlideModel("https://www.central.com.ph/iv2-css/bookstoreplus/images/online_Bookstore.jpg", ScaleTypes.FIT));
        sliderModels.add(new SlideModel("https://img.freepik.com/free-vector/online-library-app-reading-banner_33099-1733.jpg",ScaleTypes.FIT));
    ...
    private void showNewAvailables() {
        ...
        adapter = new FirestoreRecyclerAdapter<SellingBook, SellingBooksViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NotNull SellingBooksViewHolder viewHolder, int position, @NotNull final SellingBook model) {
                viewHolder.row_price.setText(String.format("%d BDT", model.getSellingprice()));
